...
exports.convertAddress = exports.checkAddress = exports.checkEthChecksumAddress = exports.isEthAddress = exports.genMultiSigAddress = exports.genSingleSigAddress = exports.genAddress = exports.VAULT_MULTI_SIG_ADDRESS_PREFIX = exports.VAULT_SINGLE_SIG_ADDRESS_PREFIX = exports.NORMAL_MULTI_SIG_ADDRESS_PREFIX = exports.NORMAL_SINGLE_SIG_ADDRESS_PREFIX = undefined;
...
var _eip = require('eip55');

var eip55 = _interopRequireWildcard(_eip);
...
var isEthAddress = exports.isEthAddress = function isEthAddress(address) {
    return (/^0[xX][0-9a-fA-F]{40}$/.test(address)
    );
};

var checkEthChecksumAddress = exports.checkEthChecksumAddress = function checkEthChecksumAddress(address) {
